...
public class ConnectionUtil {
    ...
    private static final String URL = "jdbc:mysql://remotemysql.com:3306/FbAHPSDJBF";
    private static final String USERNAME = "FbAHPSDJBF";
    private static final String PASSWORD = "nVdrchBEiH";
